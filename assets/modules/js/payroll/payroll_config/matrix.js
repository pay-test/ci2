...
$(document).ready(function() {
    ...
    table = $('#table_matrix').DataTable({ 
        ...
        "ajax": {
            "url": "payroll_config/matrix_list/",
            "type": "POST"
        },
    ...
    $('#table_matrix_wrapper .dataTables_length select').addClass("select2-wrapper span12");
...
function edit_user(id)
{
    ...
    $.ajax({
        url : "payroll_config/ajax_edit/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "payroll_config/ajax_add";
    } else {
        url = "payroll_config/ajax_update";
    }
...
function delete_user(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "payroll_config/ajax_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
