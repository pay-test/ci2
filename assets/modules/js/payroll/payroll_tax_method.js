...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "payroll_tax_method/ajax_list/",
            "type": "POST"
        },
...
function edit_user(id)
{
    ...
    $.ajax({
        url : "payroll_tax_method/ajax_edit/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "payroll_tax_method/ajax_add";
    } else {
        url = "payroll_tax_method/ajax_update";
    }
...
function delete_user(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "payroll_tax_method/ajax_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
