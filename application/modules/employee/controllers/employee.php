...
class employee extends CI_Controller {
    ...
    $data = GetHeaderFooter();
		...
		$data['grid'] = array("Nama","NIK","Group","Gender","BOD");
	...
	function update()
	{
		...
		if($id > 0)
		{
			...
			$this->db->where("person_id", $id);
			$this->db->update("kg_hris_employee", array("employee_grup"=> $this->input->post("employee_grup")));
	...
	function exe_shift($person_id, $thn=2016) 
	{
		$webmaster_id = permission();
		$grup=array("A", "B", "C", "D");
