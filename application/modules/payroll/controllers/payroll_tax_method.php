...
class Payroll_tax_method extends MX_Controller {
    
    var $title = "payroll";
    var $page_title = "Tax Method";
    var $filename = "payroll_tax_method";
    public $data;
    function __construct()
    {
        parent::__construct();
        $this->load->model('payroll_tax_method_model','payroll');
    }
