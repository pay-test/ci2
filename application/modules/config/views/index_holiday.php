...
<div class="page-content">
  ...
  <div class="content">
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('config/holiday')?>" class="active"><?php echo ucwords(lang('holiday'))?></a> </li>
    </ul>
...
<script type="text/javascript">window.onload = function(){loadHoliday();};</script>