		  ...
		  <div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse in">
				  <div class="panel-body">
					 <form id="search_att" action="<?php echo site_url($path_file.'/list_attendance');?>" method="post">
		        <div class="row">
...
$(document).ready(function() {
  ...
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "attendance/ajax_list_att/<?php echo $start_date.'~'.$end_date.'/'.$s_regs.'/'.$s_div.'/'.$s_sec.'/'.$s_pos.'/'.$s_grade;?>",
          "type": "POST"
      },
...
var id_position = '<?php echo $s_pos;?>';
...
if(id_section > 0) get_position(id_section, id_position);
function get_position(val, val_2)
{
	$.post('<?php echo base_url();?>load/get_position',{id_section: val, id_position: val_2},function(data){
