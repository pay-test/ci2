  ...
  <div class="col-md-12">
  	<div id="coba" class="grid simple transparent">
			<div class="grid-title">
				<h4>List of <span class="semi-bold"><?php echo ucwords(lang('cuti'))?></span></h4>
			</div>
		</div>
		  ...
		  <div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse in">
				  <div class="panel-body">
					 <form id="search_cuti" action="<?php echo site_url($path_file.'/history_cuti');?>" method="post">
		        <div class="row">
	              ...
	              <div class="col-md-2">
	                  ...
	                  <div class="row">
	                    <div class="col-md-12">
	                        <button type="submit" class="btn btn-info btn-search-cuti"><i class="fa fa-search"></i></button>
	                    </div>
	                  </div>
	              </div>
		          </div>
...
$(document).ready(function() {
  ...
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": $("#base_url").val()+"attendance_form/ajax_list_cuti/<?php echo $start_date.'~'.$end_date;?>",
          "type": "POST"
      },
      /*"createdRow": function ( row, data, index ) {
        if (data[4].match('Waiting')) {
