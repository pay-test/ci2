  	...
  	<div class="col-md-12">
		    <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  <div class="col-md-9">
                      <span>: <?php echo $r['job_class_nm'];?></span>
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  ...
                  <div class="col-md-9">
                      <span>: <?php echo $r['group_shift'];?></span>
                  </div>
                  <br/><br/>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-9">
                      <span>: <?php echo intval($r['grade']);?></span>
                  </div>
                  <br/><br/>
                  <div class="col-md-3">
...
$(document).ready(function() {
  ...
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "attendance/ajax_list_detail_ovt/<?php echo $period.'/'.$id_emp;?>",
          "type": "POST"
      },
