  ...
  <div class="col-md-12">
  	<div id="coba" class="grid simple transparent">
			<div class="grid-title">
				<h4><?php echo ucwords(lang('cuti'))?> <span class="semi-bold">Request Status</span></h4>
			</div>
		</div>
		  ...
		  <div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse in">
				  <div class="panel-body">
					 <form id="search_cuti" action="<?php echo site_url($path_file.'/approval_cuti');?>" method="post">
		        <div class="row">
...
$(document).ready(function() {
  ...
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": $("#base_url").val()+"attendance_form/ajax_list_cuti_app/<?php echo $start_date.'~'.$end_date;?>",
          "type": "POST"
      },
      "createdRow": function ( row, data, index ) {
        if (data[6].match('Waiting')) {
