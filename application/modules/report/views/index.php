...
<div class="page-content">
  ...
  <div class="content">
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('report/overtime')?>" class="active"><?php echo ucwords(lang('overtime'))?></a> </li>
    </ul>
...
<script type="text/javascript">window.onload = function(){loadOvertime();};</script>