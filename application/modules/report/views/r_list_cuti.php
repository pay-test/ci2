...
<div id="title">
	<table width="100%" style="margin-bottom:10px;">
		...
		if(!$report) {?>
		<tr class="head">
			<td colspan="4" style="padding-bottom:20px;"><img src="<?php echo base_url();?>assets/assets/img/logo.png" width="150"></td>
			<td colspan="2" style="text-align:right;padding-bottom:10px;">
				<a style="text-decoration:none;" href="javascript:void(0);" onClick="window.location='<?php echo site_url("report/list_cuti/1/".$start_date."~".$end_date."/".$div."/".$sec."/".$pos."/".$grade);?>'"><img src="<?php echo assets_url('assets/img/excel.png');?>"></a>
				<a style="text-decoration:none;" href="javascript:void(0);" onClick="print();"><img src="<?php echo assets_url('assets/img/print.png');?>"></a>
			</td>
		</tr>
		<?php }?>
		<tr>
			<td colspan="4">LIST OF LEAVE</td>
			<td colspan="2" style="text-align:right;">Division : <?php $title = GetValue("org_nm", "hris_orgs", array("org_id"=> "where/".$div));echo ($title) ? $title : "All";?></td>
		</tr>
		<tr>
			<td colspan="4">Period : <?php echo "<b>".$period."</b>";?></td>
			<td colspan="2" style="text-align:right;">Section : <?php $title = GetValue("org_nm", "hris_orgs", array("org_id"=> "where/".$sec));echo ($title) ? $title : "All";?></td>
		</tr>
	</table>
</div>
<div class="grid-body">
